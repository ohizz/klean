...
<div className='flex mb-14 mx-10 md:mx-0 lg:mb-0 flex-col text-center w-2/2 lg:w-1/2'>
        <h1 className='text-zinc-900 text-5xl md:text-7xl leading-tight lg:leading-tighter pb-8 lg:font-black'>
            Your <span className='text-blue-600'>cleaning service</span> for everything cleaning
        </h1>
        <button className=' w-3/4 bg-zinc-900 text-sm font-thin text-slate-200 rounded p-4 self-center'>Try it out now</button>
