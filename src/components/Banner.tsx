...
<div className='flex mb-14 mx-8 md:mx-0 lg:mb-0 flex-col text-center w-2/2 lg:w-1/2'>
        <h1 className='text-zinc-900 text-6xl md:text-7xl leading-tighter pb-8 font-black'>
