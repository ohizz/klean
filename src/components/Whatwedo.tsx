 ...
 return(
    <div className=" mt-10 px-8 ">
        <div className=" flex flex-wrap md:flex-nowrap justify-between item-center flex-col md:flex-row">
                <img src="https://hellamaid.ca/wp-content/uploads/2023/02/3-5.jpg" className="object-cover h-[450px] w-[100%] md:w-[45%] rounded-lg"/>
        ...
        <img className="order-[2] object-cover h-[450px] w-[100%] md:w-[45%] rounded-lg" src="https://www.thaicleaningservice.com/wp-content/uploads/2018/03/cleanliness-2799464_640.jpg"/>
        <div className="flex justify-center item-center flex-col  w-2/2 md:w-[45%]">
