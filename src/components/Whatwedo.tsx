...
const Whatwedo = () => {
 return(
    <div className=" mt-10 px-4">
        ...
        <p className="font-sans text-md leading-5 text-slate-600 tracking-tighter">let us help you with your residential cleaning, we do thorogh cleaning of your house. your toilet, kitchen, bedroom, bathroom, living room, atorgae room, guest room and pantry</p>
        </div>
        </div>
        ...
        <div className="flex justify-center item-center flex-col  w-2/2 md:w-[45%]">
            ...
            <p className="font-sans text-md leading-5 text-slate-600 tracking-tighter"></p>
            </div>
        </div>
        </div>
